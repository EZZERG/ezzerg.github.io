export default function Footer() {
  return (
    <footer id="footer" className="bg-amber-100 dark:bg-black text-gray-800 dark:text-white py-20">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center space-y-12">
          <div className="max-w-2xl">
            <h3 className="text-3xl font-bold mb-4">Get in Touch</h3>
            <p className="text-lg text-gray-600 dark:text-gray-400">Feel free to reach out for collaborations or just a friendly hello</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full max-w-3xl">
            <a
              ...
              aria-label="Email"
            >
              <svg className="w-8 h-8 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              aria-label="GitHub"
            >
              <svg className="w-8 h-8 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">Google Scholar</span>
            </a>
          </div>
        </div>
      </div>
