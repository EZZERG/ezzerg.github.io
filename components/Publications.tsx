        ...
        <div className="inline-flex rounded-xl glass-card p-1 shadow-lg">
          {years.map((year) => (
            <motion.button
              ...
              className={`px-4 py-2 rounded-lg transition-all duration-300 ${filterYear === year
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass-card rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border-2 border-white/30 dark:border-gray-700/50 bg-white/90 dark:bg-gray-900/90"
          ...
          <div className="flex flex-wrap gap-4">
            {(paper.pdfUrl || paper.url) && (
              ...
              >
                ...
                {paper.pdfUrl ? 'Paper PDF' : 'Paper Link'}
              </a>
            )}

            {paper.links.arxiv && paper.links.arxiv !== paper.url && (
              <a
